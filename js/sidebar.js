...
document.writeln('		.topBar .car{ width: 37px; height: 80px; padding-top: 30px; background: url(images/red_car.png) 10px 10px no-repeat;text-align: center; font-size: 12px; color:#FFF; position: relative;}');
document.writeln('		.topBar .car:hover{ background-color:#ffaa01; background-image: url(images/wite_car.png);}');
...
document.writeln('		.topBar .kefu{  background:url(images/kefu.png) 9px 10px no-repeat;}');
document.writeln('		.topBar .fankui{  background:url(images/fankui.png) 8px 10px no-repeat;}');
document.writeln('		.topBar .yanshi{  background:url(images/yanshi.png) 8px 14px no-repeat;}');
...
document.writeln('	background:url(images/sanjiao.png) no-repeat; position: absolute; ');document.writeln('right: -13px; top:13px;}');

document.writeln('.topBar .car i{ padding:7px 7px;font-size: 0px;position: absolute;display:none;');
document.writeln('background:url(images/wite_sanjiao.png) no-repeat;left:-1px; top:45px;}');
...
document.writeln('		#carBox .carBoxContent i{ padding:7px 7px;  font-size: 0px; background:url(images/wite_sanjiao.png) no-repeat; position: absolute; right: -13px; top:45px;}');
